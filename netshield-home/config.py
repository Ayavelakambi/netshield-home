...
def current_network() -> ipaddress.IPv4Network:
    """The local network object — a /24 (home LAN), overridable via env."""
    ...
    if host.startswith("127."):
        # No routable address — assume a typical home LAN so the app still
        # boots and shows a (degraded) discovery experience.
